...
{   
    ...
    private void initComponents() {
        ...
        jLabel7.setText("El software NO alcamena sus contraseñas");
        ...
        jMenu5.setText("Asimetricos");

        jMenuItem4.setText("RSA");
        jMenu5.add(jMenuItem4);

        jMenuItem6.setText("HASH");
