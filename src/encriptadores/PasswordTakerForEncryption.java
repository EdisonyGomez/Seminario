...
public class PasswordTakerForEncryption extends javax.swing.JFrame
{
    ...
    public PasswordTakerForEncryption(File[] listOfFilesAndFolders)
    {
        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                int result = JOptionPane.showConfirmDialog(frame, "Estás seguro de salir?", "Cerrar aplicación", JOptionPane.YES_NO_OPTION);
    ...
    boolean verifyPasswords()
    {
        ...
        {
            eightCharInstructionLabel.setText("por razones de seguridad tu contraseña debe ser de almenos 8 caracteres");
        ...
        if(password1.length>7)
        {
            ...
            eightCharInstructionLabel.setText("Las contraseñas no coninciden!");
            eightCharInstructionLabel.setVisible(true);
        }
